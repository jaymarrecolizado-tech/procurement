<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Assign Approvers: Purchase Request ') . $purchaseRequest->pr_number }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="mb-6 bg-blue-50 border border-blue-200 rounded-md p-4">
                        ...
                        <p class="text-sm text-gray-600">Status: <strong>{{ $purchaseRequest->status_name }}</strong></p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('purchase-requests.store-approvers', $purchaseRequest) }}" id="approversForm">
                        @csrf
