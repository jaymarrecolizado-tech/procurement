        ...
        <div class="mt-4">
            <div class="bg-blue-50 border border-blue-200 rounded-md p-3">
                <p class="text-sm text-blue-800">
                    <strong>Note:</strong> New registrations are automatically assigned the "End User" role. 
                    Other roles must be assigned by administrators after account approval.
                </p>
            </div>
        </div>
